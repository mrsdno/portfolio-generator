...
const generageProjects = projectsArr => {
    // CODE TO GENERATE THE HTML THROUGH SEPARATE ARRAYS
    ...
    // REFACTORED CODE TO CREATE THE ARRAYS BY NESTING
...
module.exports = templateData => {
    ...
    //destructure projects and about dat from templateData based on their property key names
